...
package com.ceos.merlot.pva.core;
 ...
 * @author cgarcia
 */
public class MerlotRPCClientImpl implements RPCClient, ChannelRequester, ChannelRPCRequester {
    ...
    public MerlotRPCClientImpl(String hostName, String channelName) {
        this(null,hostName, channelName);
    }
    
    public MerlotRPCClientImpl(RPCClientRequester requester, String hostName, String channelName) {
