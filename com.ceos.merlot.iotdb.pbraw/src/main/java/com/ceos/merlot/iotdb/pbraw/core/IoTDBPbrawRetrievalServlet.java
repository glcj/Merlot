 ...
 * @author cgarcia
 */
public class IoTDBPbrawRetrievalServlet extends HttpServlet{
    
    private final JdbcService jdbcService;

    public IoTDBPbrawRetrievalServlet(JdbcService jdbcService) {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        System.out.println("IoTDBPbrawRetrievalServlet: \r\n" + sb.toString()); 
