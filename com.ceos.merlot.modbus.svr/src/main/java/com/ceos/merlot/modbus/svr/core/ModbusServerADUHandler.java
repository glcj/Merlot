...
import com.ceos.merlot.modbus.dev.api.Modbus;
import com.ceos.merlot.modbus.dev.api.ModbusDevice;
import com.ceos.merlot.modbus.dev.api.ModbusDeviceArray;
import com.ceos.merlot.modbus.dev.impl.ModbusDeviceArrayImpl;
import com.ceos.merlot.modbus.svr.api.ModbusADU;
import com.ceos.merlot.modbus.svr.impl.ModbusADUImpl;
    ...
    private ModbusADU doFC_Write_Single_Coil(ModbusADU rxADU){
        ...
        if ((Value == (short) 0x0000) || (Value == (short) 0xFF00)) {
            ...
            if (Starting_address <= Coils.capacity() * 8) {
                try {
                    System.out.println("Número de bobinas aceptada!.");
