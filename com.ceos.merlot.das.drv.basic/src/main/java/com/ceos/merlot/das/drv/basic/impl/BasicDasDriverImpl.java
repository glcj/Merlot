...
import static com.ceos.merlot.das.drv.basic.impl.BasicDriverImpl.BASIC_DEVICE_CATEGORY;
 ...
 * @author cgarcia
 */
public class BasicDasDriverImpl implements Driver {

    private static final Logger LOGGER = LoggerFactory.getLogger(BasicDasDriverImpl.class);    
    
    @Reference
    private BundleContext bc;
    
    private BasicDevice bdev;
    ...
    */
            ...
            if (deviceCategory.equals(BASIC_DEVICE_CATEGORY)) {             
                {
                    ServiceReference[] services = bc.getServiceReferences(
                            BasicDriver.class.getName(), null);
                    if (services.length > 0){
                        ...
                        BasicDriver driver = new BasicDriverImpl(bc);
                        
                        bc.registerService(BasicDriver.class.getName(), driver, props);
    ...
    public String attach(ServiceReference reference) throws Exception {
        ...
        if (reference != null) {
            ...
            bdev = (BasicDevice) bc.getService(reference);
