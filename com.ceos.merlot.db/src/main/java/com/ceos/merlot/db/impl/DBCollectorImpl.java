...
import com.ceos.merlot.db.api.DBCollector;
...
public class DBCollectorImpl implements DBCollector, PVListener {
    ...
    private final BasicDriver devDriver;
    ...
    public void execute(DriverEvent cb) {
        ...
        if (cb.getPlcReadResponse() != null) {           
            ...
            Set<String> strFields = drvRequest.getFieldNames();
    ...
    public void attach(Collection<PVRecord> pvRecords) {
        ...
        if (plcConn.isConnected()){      
            ...
            for (PVRecord pvRecord:pvRecords){
                ...
                readRequestBuilder.addItem(pvRecord.getRecordName(), pvRecord.getPVStructure().getStringField("id").get());
    ...
    private BasicDriver getDriver(String device){
        try{
            ...
            BasicDriver refdrv = (BasicDriver) bundleContext.getService(refdrvs[0]);
            return refdrv;            
        } catch (Exception ex){
...
;                     
    ...
    private void writeScalar(PVRecord pvRecord){
        try {    
            ...
            writeRequestBuilder.addItem(pvRecord.getRecordName(), 
